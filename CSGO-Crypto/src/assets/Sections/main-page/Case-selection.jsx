  ...
  return (
    ...
    <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-gray-900 rounded-lg p-6 hover:scale-105 transition-all duration-300 cursor-pointer">
            <img
              ...
              alt="Elite Case"
              className="w-full h-32 object-cover rounded mb-4 active-edit-image"
            />
            <h3 className="text-white font-bold mb-2">Elite Case</h3>
            <p className="text-purple-400 mb-4">0.05 BTC</p>
          ...
          <div className="bg-gray-900 rounded-lg p-6 hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            />
            <h3 className="text-white font-bold mb-2">Pro Case</h3>
            <p className="text-purple-400 mb-4">0.1 BTC</p>
            <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 rounded transition-colors">
              Open Case
            </button>
          </div>
          <div className="bg-gray-900 rounded-lg p-6 hover:scale-105 transition-all duration-300 cursor-pointer">
            <img
              ...
              className="w-full h-32 object-cover rounded mb-4"
            />
            <h3 className="text-white font-bold mb-2">Legendary Case</h3>
            <p className="text-purple-400 mb-4">0.5 BTC</p>
            <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 rounded transition-colors">
              Open Case
            </button>
          </div>
          <div className="bg-gray-900 rounded-lg p-6 hover:scale-105 transition-all duration-300 cursor-pointer">
            <img
              ...
              className="w-full h-32 object-cover rounded mb-4"
            />
            <h3 className="text-white font-bold mb-2">Ultimate Case</h3>
            <p className="text-purple-400 mb-4">1.0 BTC</p>
            <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 rounded transition-colors">
              Open Case
            </button>
          </div>
